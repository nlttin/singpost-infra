...
dependency "vpc" {
  ...
  mock_outputs = {
    vpc_self_link = "projects/singpost/global/networks/singpost-preprod-vpc"
  }
}
...
dependency "cloud_sql" {
  ...
  mock_outputs = {
    cloudsql_connection_name = "singpost-preprod:asia-southeast1:singpost-db"
  }
}
...
inputs = {
  ...
  vpc_connector_cidr      = "10.3.100.0/24"
